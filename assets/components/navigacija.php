<div class="row">
    <nav class="col-12 ps-0 pe-0" id="navigacija">
        <nav class="navbar navbar-expand-lg ">
            <a class="navbar-brand" href="#">
                Brand
            </a>
            <button class="navbar-toggler me-3 collapsed" type="button" data-toggle="collapse" data-target="#navbarNav"
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="taxi-zum-flughafen.php">link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="taxi-vom-flughafen.php">link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#kontakt">link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="flughafen-taxi-preis.php">link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="agb.php">link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#kontakt" aria-label="language english">
