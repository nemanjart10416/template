...
<a href="#navbar" class="btn back-top">
        ...
        <div class="item">
            <div class="icon">
                <a href="tel:+4368181811608">
                    <svg width="24" height="24" viewBox="-2 -1.5 24 24" xmlns="http://www.w3.org/2000/svg"
                         preserveAspectRatio="xMinYMin" class="p-1">
